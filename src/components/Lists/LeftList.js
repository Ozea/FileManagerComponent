...
import Row from './Row';
import LeftMenu from '../Panels/LeftMenu';
import '../../App.css';
...
class LeftList extends Component {
  ...
  render() {
    let className = this.props.isActive ? "left-list active" : "left-list"
    return (
      <div className={className} onClick={this.handleClick} >
        {this.handleLiSelection()}
        <Head class={this.props.isActive ? "active-head" : "head"} />
        <LeftMenu class={this.props.isActive ? "active-panel panel" : "inactive-panel panel"} />
        <ul onChange={this.handleSwitchList}>
